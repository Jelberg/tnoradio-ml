...
_charset_mimetypes = {
    ...
    "app/xml",
    "app/xml-dtd",
    "app/xml-external-parsed-entity",
}
...
def get_content_type(mimetype: str, charset: str) -> str:
    ...
    .. versionchanged:: 0.15
        ...
        that start with ``app/``. Known text types such as
        ``app/javascript`` are also given charsets.
    """
    if (
...
def redirect(
    ...
    """Returns a response object (a WSGI app) that, if called,
