...
apps. However, they are not Werkzeug response objects. You
...
class HTTPException(Exception):
    ...
    app to render a default error page or you can catch the subclasses
    ...
    def __call__(
        ...
        """Call the exception as WSGI app.
...
class BadRequest(HTTPException):
    ...
    Raise if the browser sends something to the app the app
...
class NotImplemented(HTTPException):
    ...
    Raise if the app does not support the action requested by the
    browser.
    """
...
class BadGateway(HTTPException):
    ...
    If you do proxying in your app you should return this status code
...
class Aborter:
    ...
    a WSGI app it will be raised in a proxy exception.
...
def abort(
    ...
    exceptions and will raise that exception.  If passed a WSGI app,
