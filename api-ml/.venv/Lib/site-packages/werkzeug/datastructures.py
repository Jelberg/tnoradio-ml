    ...
    def add_file(self, name, file, filename=None, content_type=None):
        ...
        if isinstance(file, FileStorage):
            ...
            if filename and content_type is None:
                content_type = (
                    mimetypes.guess_type(filename)[0] or "app/octet-stream"
                )
...
class MIMEAccept(Accept):
    ...
    def _value_matches(self, value, item):
        ...
        # value comes from the app, tell the developer when it
        # doesn't look valid.
        if "/" not in value:
    ...
    def accept_html(self):
        ...
        return (
            "text/html" in self or "app/xhtml+xml" in self or self.accept_xhtml
        )

    @property
    def accept_xhtml(self):
        """True if this object accepts XHTML."""
        return "app/xhtml+xml" in self or "app/xml" in self

    @property
    def accept_json(self):
        """True if this object accepts JSON."""
        return "app/json" in self
