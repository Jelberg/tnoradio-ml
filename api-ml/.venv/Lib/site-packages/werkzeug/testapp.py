"""A small app that can be used to test a WSGI server and check
...
def test_app(
    ...
    """Simple test app that dumps the environment.  You can use
    ...
    The app displays important information from the WSGI environment,
