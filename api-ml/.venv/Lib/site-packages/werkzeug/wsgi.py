...
def responder(f: t.Callable[..., "WSGIapp"]) -> "WSGIapp":
    """Marks a function as responder.  Decorate a function with it and it
    will automatically call the return value as WSGI app.
...
class ClosingIterator:
    ...
    respect the `close` callback of the iterable returned by the app.
    ...
    A closing iterator is not needed if the app uses response objects
...
def wrap_file(
    ...
    iterate over it from inside the app but to pass it through
