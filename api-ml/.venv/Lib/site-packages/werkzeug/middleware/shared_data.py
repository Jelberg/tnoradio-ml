...
class SharedDataMiddleware:
    ...
    mounted on the root folder and still continue to use the app because
    the shared data middleware forwards all unhandled requests to the
    app, even if the requests are below one of the shared folders.
    ...
    This will then serve the ``static`` folder in the `myapp`
    Python package.
    ...
    :param app: the app to wrap.  If you don't want to wrap an
                app you can pass it :exc:`NotFound`.
    ...
    .. versionchanged:: 1.0
        ...
        ``app/octet-stream``. If a filename looks like a text
    ...
    def __init__(
        ...
        fallback_mimetype: str = "app/octet-stream",
    ) -> None:
        self.app = app
