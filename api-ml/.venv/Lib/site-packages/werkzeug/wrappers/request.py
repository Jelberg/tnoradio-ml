...
class Request(_SansIORequest):
    ...
    :param shallow: Makes reading from :attr:`stream` (and any method
        ...
        it unavailable to the final app.
    ...
    @classmethod
    def app(
        cls, f: t.Callable[["Request"], "WSGIapp"]
    ) -> "WSGIapp":
    ...
    is_multithread = environ_property[bool](
        "wsgi.multithread",
        doc="""boolean that is `True` if the app is served by a
    ...
    is_run_once = environ_property[bool](
        "wsgi.run_once",
        doc="""boolean that is `True` if the app will be
    ...
    def json(self) -> t.Optional[t.Any]:
        ...
        If the request content type is not ``app/json``, this
    ...
    def get_json(
        ...
        (:mimetype:`app/json`, see :attr:`is_json`), or parsing
    ...
    def on_json_loading_failed(self, e: t.Optional[ValueError]) -> t.Any:
        ...
        :param e: If parsing failed, this is the exception. It will be
            ``None`` if the content type wasn't ``app/json``.
        """
        if e is not None:
