...
class Response(_SansIOResponse):
    ...
    The response object is itself a WSGI app callable. When
    ...
    def force_type(
        ...
        is provided::
            ...
            # convert any WSGI app into a response object
        ...
        :param response: a response object or wsgi app.
        ...
        if not isinstance(response, Response):
            if environ is None:
                raise TypeError(
                    "cannot convert WSGI app into response"
    ...
    @classmethod
    def from_app(
        cls, app: "WSGIapp", environ: "WSGIEnvironment", buffered: bool = False
    ) -> "Response":
        """Create a new response object from an app output.  This
        works best if you pass it an app that returns a generator all
        the time.  Sometimes apps may use the `write()` callable
        returned by the `start_response` function.  This tries to resolve such
        edge cases automatically.  But if you don't get the expected output
        you should set `buffered` to `True` which enforces buffering.

        :param app: the WSGI app to execute.
    ...
    def iter_encoded(self) -> t.Iterator[bytes]:
        ...
        If the response object is invoked as WSGI app the return
        value of this method is used as app iterator unless
    ...
    def get_app_iter(self, environ: "WSGIEnvironment") -> t.Iterable[bytes]:
        """Returns the app iterator for the given environ.  Depending
    ...
    def get_wsgi_response(
        ...
        the tuple is the app iterator, the second the status and
    ...
    def __call__(
        ...
        """Process this response as WSGI app.

        :param environ: the WSGI environment.
        :param start_response: the response callable provided by the WSGI
                               server.
        :return: an app iterator
        """
    ...
    def json(self) -> t.Optional[t.Any]:
        ...
        (:mimetype:`app/json`, see :attr:`is_json`).
    ...
    def get_json(self, force: bool = False, silent: bool = False) -> t.Optional[t.Any]:
        ...
        (:mimetype:`app/json`, see :attr:`is_json`), this
        returns ``None``.
