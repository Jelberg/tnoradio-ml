...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def run_wsgi(self) -> None:
        ...
        def write(data: bytes) -> None:
            ...
            assert isinstance(data, bytes), "apps must write bytes"
...
def run_simple(
    ...
    """Start a development server for a WSGI app. Various
    ...
    if use_debugger:
        from .debug import Debuggedapp

        app = Debuggedapp(app, evalex=use_evalex)
