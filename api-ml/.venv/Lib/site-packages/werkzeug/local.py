...
class LocalManager:
    ...
    def make_middleware(self, app: "WSGIapp") -> "WSGIapp":
        """Wrap a WSGI app so that cleaning up happens after
        request end.
        """
    ...
    def middleware(self, func: "WSGIapp") -> "WSGIapp":
        ...
        will have all the arguments copied from the inner app
