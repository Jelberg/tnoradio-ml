...
def get_pin_and_cookie_name(
    ...
    """Given an app object this returns a semi-stable 9 digit pin
...
class Debuggedapp:
    """Enables debugging support for a given app::

        from werkzeug.debug import Debuggedapp
        from myapp import app
        app = Debuggedapp(app, evalex=True)

    The `evalex` keyword argument allows evaluating expressions in a
    traceback's frame context.

    :param app: the WSGI app to run debugged.
    ...
    def debug_app(
        ...
        """Run the app and conserve the traceback frames."""
        app_iter = None
        try:
    ...
    def __call__(
        ...
        # form data!  Otherwise the app won't have access to that data
        # any more!
        request = Request(environ)
        response = self.debug_app
