...
class Request:
    ...
    implementing WSGI, ASGI, or another HTTP app spec. Werkzeug
    ...
    :param root_path: The prefix that the app is mounted under.
    ...
    #: the app is being run behind one).
    #:
    #: .. versionadded:: 0.9
    ...
    def is_json(self) -> bool:
        ...
        :mimetype:`app/json` or :mimetype:`app/*+json`.
        """
        mt = self.mimetype
        return (
            mt == "app/json"
            or mt.startswith("app/")
