...
def get_app_dir(app_name: str, roaming: bool = True, force_posix: bool = False) -> str:
    r"""Returns the config folder for the app.  The default behavior
    ...
    :param app_name: the app name.  This should be properly capitalized
    ...
    if sys.platform == "darwin":
        return os.path.join(
            os.path.expanduser("~/Library/app Support"), app_name
        )
    return os.path.join(
