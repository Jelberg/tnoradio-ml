...
class PythonLexer(RegexLexer):
    ...
    filenames = [
        ...
        'BUILD.bazel',
        'WORKSPACE',
        # Twisted app infrastructure
        '*.tac',
    ]
    mimetypes = ['text/x-python', 'app/x-python',
                 'text/x-python3', 'app/x-python3']
...
class Python2Lexer(RegexLexer):
    ...
    mimetypes = ['text/x-python2', 'app/x-python2']
...
class CythonLexer(RegexLexer):
    ...
    mimetypes = ['text/x-cython', 'app/x-cython']
